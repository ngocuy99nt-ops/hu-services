      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-ink sm:text-4xl md:text-5xl">
            Đầu tư theo đúng loại dự án
          </h2>
          <p className="mt-4 text-lg text-muted">
            Không có mức giá cố định gây hiểu nhầm — mỗi dự án được báo giá theo phạm vi thực tế.
          </p>
        </motion.div>
          ...
          {PRICING_TIERS.map((tier) => (
            <motion.div
              ...
              className={`flex flex-col rounded-2xl border p-6 ${
                tier.highlighted ? "border-accent/40 bg-card shadow-lg shadow-primary/10" : "border-white/10 bg-card"
              }`}
            >
        ...
        >
          <a
            href="#contact"
            className="group inline-flex items-center justify-center gap-2 rounded-full bg-primary px-7 py-3.5 text-base font-semibold text-ink shadow-lg shadow-primary/20 transition-all hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
          >
